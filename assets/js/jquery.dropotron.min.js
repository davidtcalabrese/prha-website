...
!function (e) {
    e.fn.disableSelection_dropotron = function () {
        ...
        var o = e.extend({
                ...
                detach: !0,
                cloneOnDetach: !0
            }, t), n = o.selectorParent, s = n.find("ul"), i = e("body"), a = e("body,html"), l = e(window), r = !1,
            d = null, c = null;
        n.on("doCollapseAll", function () {
            ...
            o.hideDelay > 0 && t.add(n).on("mouseleave", function (e) {
                ...
                var i, a, d, f, u = n.offset(), p = n.position(), h = (n.parent().position(), n.outerWidth()),
                ...
                return t.is(":visible") ? (t.hide(),
                    n.not('.active').removeClass(o.openerActiveClass), // Exclude `active`
                    t.find("." + o.openerActiveClass).not('.active').removeClass(o.openerActiveClass),
                    t.find("ul").hide(),
                    !1) : !1;
